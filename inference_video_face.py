...
parser = argparse.ArgumentParser(description='Tensorflow Live Face Detector')
parser.add_argument('--model', metavar='PATH',
                    help='path to frozen graph (.pb)', default='./detector_models/base_SSD_MobilenetV1_face.pb')
